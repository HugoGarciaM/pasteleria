        ...
        <div class="d-flex p-3 justify-content-between">
            <div class="card bg-success" style="width: 49%;">
                <div class="card-content p-2">
                    ...
                    <h3 class="d-inline">Total: {{$dailySalesBySeller!=null ? $dailySalesBySeller->total_revenue : 0}}</h3>
                </div>
            </div>
            ...
            <div class="card bg-primary" style="width: 49%;">
                <div class="card-content p-2">
                    ...
                    <h3 class="d-inline">Cantidad: {{$dailySalesBySeller!=null ? $dailySalesBySeller->total_quantity : 0}}</h3>
                </div>
            </div>
        </div>
    </div>
